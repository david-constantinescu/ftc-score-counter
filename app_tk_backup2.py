...
CONFIRM_FRAMES  = 3          # frames before a ball is "confirmed"
...
class GoalScorerApp:
    ...
    def _video_loop(self):
        t0 = time.time()
        self._frame_no += 1
        use_yolo = self.detector.ready and (self._frame_no % self._yolo_every == 0)
        ...
        # Schedule next tick (~30 fps target, never less than 10 ms)
        delay = max(10, 33 - int(dt * 1000))
